...
option options[] = {
    ...
    {"symmetric",       "sym"}, //26
    {"appendCols",  "appcols"}, //27
    {"appendRows",  "approws"}, //28
    {"congruent",    "congrt"}, //29
    {"\0", "\0"}
};
    ...
    while(true) 
    {
        ...
        switch(search(options, cmd))
        {
            ...
            case 26:
            {
                ...
                if (dictionary[loc].reference->symmetric())
            ...
            case 27:
            {
                ...
                if (dictionary[loc1].reference->Height() != dictionary[loc2].reference->Height())
                {
                    printf("%s must have the same height as %s", name1.data(), name2.data());
                    continue;
                }
                dictionary[loc1].reference->appendCols(*dictionary[loc2].reference);
                cout << *dictionary[loc1].reference;
                break;
            }
            ...
            case 28:
            {
                ...
                if (dictionary[loc1].reference->Height() != dictionary[loc2].reference->Height())
                {
                    printf("%s must have the same width as %s", name1.data(), name2.data());
                    continue;
                }
                dictionary[loc1].reference->appendRows(*dictionary[loc2].reference);
                cout << *dictionary[loc1].reference;
                break;
            }
            ...
            case 29:
            {
                ...
                int width1 = dictionary[loc1].reference->Width();
                int height1 = dictionary[loc1].reference->Height();
                int width2 = dictionary[loc2].reference->Width();
                int height2 = dictionary[loc2].reference->Height();
                if (width1 != height1)
                {
                    printf("The matrix to be congruent-transformed must be square!\n");
                    continue;
                }
                if (width1 != height2)
                {
                    printf("The matrix to be congruent-transformed must have the same width as transform matrix\n");
                    continue;
                }
                *dictionary[0].reference = dictionary[loc1].reference->congruentTransform(*dictionary[loc2].reference);
                cout << *dictionary[0].reference;
                break;
            }
        }
